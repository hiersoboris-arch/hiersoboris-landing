...
const LIVRET = LIVRETS["fiche-de-poste"];

export const metadata: Metadata = {
  title: "La fiche de poste qui attire : ma trame, commentée",
  description:
    "La trame gratuite d'une fiche de poste qui vend et qui filtre : les 12 blocs dans l'ordre, la fenêtre réelle de démarrage d'une alternance, l'effet de l'affichage du salaire, et un exemple complet à copier.",
  alternates: { canonical: "/livres-blancs/fiche-de-poste" },
  openGraph: {
    type: "website",
    title: "La fiche de poste qui attire · Livre blanc",
    description:
      "La trame que j'utilise pour mes propres recrutements et ceux de mes clients, bloc par bloc, avec un exemple complet.",
  },
};

const CHIFFRES = [
  { value: "40 %", caption: "de candidatures en plus quand l'annonce affiche une rémunération, même encadrée (Apec, HelloWork)" },
  { value: "12 blocs", caption: "dans l'ordre qui filtre avant l'entretien plutôt qu'après" },
  { value: "45 jours", caption: "de formation pratique pendant lesquels le contrat d'apprentissage se rompt librement, sans motif ni indemnité" },
  { value: "6 mois", caption: "la fenêtre réelle de démarrage d'un contrat d'apprentissage autour de la rentrée, pas deux semaines" },
];

export default function FicheDePosteLivreBlanc() {
  return (
    <>
      <script
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "La fiche de poste qui attire",
                item: `${SITE_URL}/livres-blancs/fiche-de-poste`,
              },
            ],
          }),
        }}
        ...
        <section className="max-w-content mx-auto px-6 pb-14 md:pb-20">
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="serif text-4xl md:text-6xl leading-[1.02] tracking-tight">
              La fiche de poste
              <br />
              <span className="italic text-bordeaux">qui attire, vraiment.</span>
            </h1>
            <p className="mt-7 text-lg text-muted max-w-2xl leading-relaxed">
              La plupart des offres d&apos;emploi sont écrites comme des fiches de fonction :
              une liste de tâches, trois adjectifs, et « rémunération selon profil ». Elles sont
              lues en huit secondes, puis abandonnées. Voici la trame que j&apos;utilise pour mes
              propres recrutements et ceux de mes clients, bloc par bloc, avec un exemple complet
              à copier.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-12 gap-10 lg:gap-16 items-start">
              <div className="md:col-span-6">
                ...
                <h2 className="serif text-3xl md:text-5xl leading-[1.05] tracking-tight">
                  Vendre le poste, et filtrer.
                </h2>
                <p className="mt-6 text-lg text-muted leading-relaxed max-w-xl">
                  Une bonne fiche de poste fait le travail inverse d&apos;une fiche de fonction :
                  elle vend le poste à quelqu&apos;un qui a le choix, et elle filtre ceux qui ne
                  conviennent pas, avant l&apos;entretien plutôt qu&apos;après.
                </p>
              ...
              <div className="md:col-span-6">
                <LivreBlancForm livret="fiche-de-poste" masquerProfil />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-content mx-auto px-6 py-14 md:py-20">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-muted leading-relaxed max-w-2xl">
                ...
                d&apos;étudiants Sales par an et je pré-qualifie les profils avant de vous les
                présenter. Vous voyez 3 bons candidats au lieu de 300 CV.
              </p>
              <Link
                href="/alternance"
